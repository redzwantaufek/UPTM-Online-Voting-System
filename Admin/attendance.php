<?php
    ...
    $sql_voted = "SELECT * FROM student WHERE votingHistory = 1";
    $result_voted = $conn->query($sql_voted);

    // Fetch students who have not voted
    $sql_not_voted = "SELECT * FROM student WHERE votingHistory = 0";
    $result_not_voted = $conn->query($sql_not_voted);
...
<head>
    ...
    <title>Student Attendance - UPTM Online Voting System</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Students who voted</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTableVoted" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php while($row = $result_voted->fetch_assoc()): ?>
                                            <tr>
                                                <td><img src="<?php echo $row['studentPic']; ?>" alt="Student Picture" style="width:50px;height:50px;"></td>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Students who did not vote</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTableNotVoted" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php while($row = $result_not_voted->fetch_assoc()): ?>
                                            <tr>
                                                <td><img src="<?php echo $row['studentPic']; ?>" alt="Student Picture" style="width:50px;height:50px;"></td>
                                                <td><?php echo $row['studentName']; ?></td>
                                                <td><?php echo $row['email']; ?></td>
